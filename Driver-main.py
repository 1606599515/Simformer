...
def get_arguments():
    parser = argparse.ArgumentParser(description='Training for DrivAerNet Datasets.')
    ...
    if os.path.exists(os.path.join('data')):
        ...
        parser.add_argument('--data_path', default='/root/autodl-fs/data-Driv/dgl', type=str,
                            help='Root directory of the dataset.')
    ...
    parser.add_argument('--input_dim_node', type=int, default=3, help='Node feature size.')
    ...
    parser.add_argument('--ckpt_root', type=str, default='ckpt-driver', help='Directory to save checkpoints.')
    parser.add_argument('--result_root', type=str, default='result-driver', help='Save Results.')
...
if __name__ == '__main__':
    ...
    train_dataset = DrivAerNetDataset(data_path=config.data_path, mode='train')
    valid_dataset = DrivAerNetDataset(data_path=config.data_path, mode='valid')
    test_dataset = DrivAerNetDataset(data_path=config.data_path, mode='test')
